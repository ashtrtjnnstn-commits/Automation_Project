...
@web_bp.route("/payments/tracker")
def payments_tracker():
    payments = Payment.query.order_by(Payment.payment_date.desc(), Payment.id.desc()).all()
    return render_template("payments_tracker.html", payments=payments)
